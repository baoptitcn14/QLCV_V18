...
@Injectable()
export class SSO_ApplicationServiceProxy {
  ...
  constructor(
    ...
    @Optional() @Inject(API_SSO_URL) baseUrl?: string
  ) {
    this.http = http;
  ...
  deleteLogCache(body: StringEntityDto | undefined): Observable<void> {
    let url_ =
      this.baseUrl + '/api/services/sso/write/Application/DeleteLogCache';
    url_ = url_.replace(/[?&]$/, '');
  ...
  protected processDeleteLogCache(
  ...
  resetCacheSSOsync(tenant: number | undefined): Observable<void> {
    let url_ =
      this.baseUrl + '/api/services/sso/write/Application/ResetCacheSSOsync?';
    if (tenant === null)
  ...
  protected processResetCacheSSOsync(
    response: HttpResponseBase
  ): Observable<void> {
    const status = response.status;
    const responseBlob =
  ...
  setQuyenUser(email: string | null | undefined): Observable<void> {
    let url_ =
      this.baseUrl + '/api/services/sso/write/Application/SetQuyenUser?';
...
@Injectable()
export class SSO_CategoryServiceProxy {
  private http: HttpClient;
  private baseUrl: string;
  protected jsonParseReviver: ((key: string, value: any) => any) | undefined =
    undefined;
   ...
   */
  getList(
    body: SSOCategoryGuidGetDto | undefined
  ): Observable<SSOCategoryOutputDto[]> {
          ...
          if (response_ instanceof HttpResponseBase) {
            try {
              ...
              return _observableThrow(
                e
              ) as any as Observable<SSOCategoryOutputDto>;
            }
          } else
            return _observableThrow(
              response_
        ...
        _observableMergeMap((_responseText: string) => {
          ...
          let resultData200 =
            _responseText === ''
              ? null
              : JSON.parse(_responseText, this.jsonParseReviver);
          result200 = SSOCategoryOutputDto.fromJS(resultData200.result);
          return _observableOf(result200);
        })
      );
    } else if (status !== 200 && status !== 204) {
   ...
   */
  create(
    body: SSOCategoryInputDto | undefined
  ): Observable<SSOCategoryOutputDto> {
...
@Injectable()
export class SSO_DataServiceProxy {
  private http: HttpClient;
  private baseUrl: string;
  protected jsonParseReviver: ((key: string, value: any) => any) | undefined =
    undefined;
  ...
  protected processGetTitle(
    response: HttpResponseBase
  ): Observable<DataOutputDto[]> {
    const status = response.status;
    const responseBlob =
      response instanceof HttpResponse
        ? response.body
...
@Injectable()
export class SSO_DataOrganizationServiceProxy {
  private http: HttpClient;
  private baseUrl: string;
  protected jsonParseReviver: ((key: string, value: any) => any) | undefined =
    undefined;
   ...
   */
  getOrganization(
    body: StringEntityDto | undefined
  ): Observable<DataOutputDto[]> {
    let url_ =
      this.baseUrl + '/api/services/sso/read/DataOrganization/GetOrganization';
    url_ = url_.replace(/[?&]$/, '');
  ...
  protected processGetOrganization(
    response: HttpResponseBase
  ): Observable<DataOutputDto[]> {
    const status = response.status;
    const responseBlob =
...
@Injectable()
export class SSO_DataUserOrganizationServiceProxy {
  private http: HttpClient;
  private baseUrl: string;
  protected jsonParseReviver: ((key: string, value: any) => any) | undefined =
    undefined;
  ...
  getUserOrganization(
    ...
    let url_ =
      this.baseUrl +
      '/api/services/sso/read/DataUserOrganization/GetUserOrganization';
    url_ = url_.replace(/[?&]$/, '');
  ...
  protected processGetUserOrganization(
    response: HttpResponseBase
  ): Observable<DataOutputDto[]> {
    const status = response.status;
    const responseBlob =
...
@Injectable()
export class SSO_FamilyServiceProxy {
  private http: HttpClient;
  private baseUrl: string;
  protected jsonParseReviver: ((key: string, value: any) => any) | undefined =
    undefined;
  ...
  protected processGetByListUserId(
    response: HttpResponseBase
  ): Observable<FamilyDto[]> {
    const status = response.status;
    const responseBlob =
...
@Injectable()
export class SSO_MenuServiceProxy {
  private http: HttpClient;
  private baseUrl: string;
  protected jsonParseReviver: ((key: string, value: any) => any) | undefined =
    undefined;
      ...
      .pipe(
        _observableCatch((response_: any) => {
          if (response_ instanceof HttpResponseBase) {
            ...
            return _observableThrow(
              response_
            ) as any as Observable<MenuOutputDto>;
        })
      );
  }
   ...
   */
  createOrUpdateList(
    body: MenuInputDto[] | null | undefined
  ): Observable<void> {
  ...
  protected processCreateOrUpdateList(
    response: HttpResponseBase
  ): Observable<void> {
    const status = response.status;
    const responseBlob =
...
@Injectable()
export class SSO_MenuClientServiceProxy {
  private http: HttpClient;
  private baseUrl: string;
  protected jsonParseReviver: ((key: string, value: any) => any) | undefined =
    undefined;
...
@Injectable()
export class SSO_NotificationServiceProxy {
  private http: HttpClient;
  private baseUrl: string;
  protected jsonParseReviver: ((key: string, value: any) => any) | undefined =
    undefined;
  ...
  getUserNotificationCount(
    body: GetUserNotificationsDto | undefined
  ): Observable<number> {
    let url_ =
      this.baseUrl +
      '/api/services/sso/read/Notification/GetUserNotificationCount';
    url_ = url_.replace(/[?&]$/, '');
  ...
  protected processGetUserNotificationCount(
    response: HttpResponseBase
  ): Observable<number> {
    const status = response.status;
    const responseBlob =
  ...
  getUserNotifications(
    ...
    let url_ =
      this.baseUrl + '/api/services/sso/read/Notification/GetUserNotifications';
    url_ = url_.replace(/[?&]$/, '');
   ...
   * @return Success
   */
  getUserNotificationsString(
    body: GetUserNotificationsDto | undefined
  ): Observable<string> {
    let url_ =
      this.baseUrl +
      '/api/services/sso/read/Notification/GetUserNotificationsString';
    url_ = url_.replace(/[?&]$/, '');
  ...
  protected processGetUserNotificationsString(
    response: HttpResponseBase
  ): Observable<string> {
    const status = response.status;
    const responseBlob =
   ...
   */
  publishNotification(
    body: RelationNotificationDto | undefined
  ): Observable<void> {
    let url_ =
      this.baseUrl + '/api/services/sso/write/Notification/PublishNotification';
    url_ = url_.replace(/[?&]$/, '');
  ...
  deleteAllUserNotification(
    body: AllUserNotificationDto | undefined
  ): Observable<void> {
    let url_ =
      this.baseUrl +
      '/api/services/sso/write/Notification/DeleteAllUserNotification';
    url_ = url_.replace(/[?&]$/, '');
  ...
  protected processDeleteAllUserNotification(
    response: HttpResponseBase
  ): Observable<void> {
    const status = response.status;
    const responseBlob =
  ...
  deleteUserNotification(
    body: UserNotificationDto | undefined
  ): Observable<void> {
    let url_ =
      this.baseUrl +
      '/api/services/sso/write/Notification/DeleteUserNotification';
    url_ = url_.replace(/[?&]$/, '');
  ...
  protected processDeleteUserNotification(
    response: HttpResponseBase
  ): Observable<void> {
    const status = response.status;
    const responseBlob =
   ...
   * @return Success
   */
  updateAllUserNotificationState(
    body: AllUserNotificationDto | undefined
  ): Observable<void> {
    let url_ =
      this.baseUrl +
      '/api/services/sso/write/Notification/UpdateAllUserNotificationState';
    url_ = url_.replace(/[?&]$/, '');
    ...
    return this.http
      ...
      .pipe(
        _observableCatch((response_: any) => {
          if (response_ instanceof HttpResponseBase) {
            try {
              return this.processUpdateAllUserNotificationState(
                response_ as any
              );
            } catch (e) {
              return _observableThrow(e) as any as Observable<void>;
  ...
  protected processUpdateAllUserNotificationState(
    response: HttpResponseBase
  ): Observable<void> {
    const status = response.status;
    const responseBlob =
  ...
  updateUserNotificationState(
    ...
    let url_ =
      this.baseUrl +
      '/api/services/sso/write/Notification/UpdateUserNotificationState';
    url_ = url_.replace(/[?&]$/, '');
  ...
  protected processUpdateUserNotificationState(
    response: HttpResponseBase
  ): Observable<void> {
    const status = response.status;
    const responseBlob =
...
@Injectable()
export class SSO_OrganizationServiceProxy {
  private http: HttpClient;
  private baseUrl: string;
  protected jsonParseReviver: ((key: string, value: any) => any) | undefined =
    undefined;
   ...
   */
  getList(
    body: OrganizationGuidGetDto | undefined
  ): Observable<OrganizationOutputDto[]> {
    ...
    if (status === 200) {
      return blobToText(responseBlob).pipe(
        _observableMergeMap((_responseText: string) => {
          ...
          if (Array.isArray(resultData200.result)) {
            result200 = [] as any;
            for (let item of resultData200.result) result200!.push(item);
          } else {
            result200 = <any>null;
          }
          return _observableOf(result200);
        ...
        _observableCatch((response_: any) => {
          if (response_ instanceof HttpResponseBase) {
            try {
              ...
              return _observableThrow(
                e
              ) as any as Observable<OrganizationOutputDto>;
            }
          } else
            return _observableThrow(
              response_
   ...
   */
  create(
    body: OrganizationInputDto | undefined
  ): Observable<OrganizationOutputDto> {
   ...
   */
  createOrUpdateList(
    body: OrganizationInputDto[] | null | undefined
  ): Observable<void> {
    let url_ =
      this.baseUrl + '/api/services/sso/write/Organization/CreateOrUpdateList';
    url_ = url_.replace(/[?&]$/, '');
  ...
  setCategories(body: OrganizationCategoryDto | undefined): Observable<void> {
    let url_ =
      this.baseUrl + '/api/services/sso/write/Organization/SetCategories';
    url_ = url_.replace(/[?&]$/, '');
...
@Injectable()
export class SSO_OrganizationClientServiceProxy {
  private http: HttpClient;
  private baseUrl: string;
  protected jsonParseReviver: ((key: string, value: any) => any) | undefined =
    undefined;
  ...
  getList(
    ...
    let url_ =
      this.baseUrl + '/api/services/sso/read/OrganizationClient/GetList';
    url_ = url_.replace(/[?&]$/, '');
...
@Injectable()
export class SSO_OrganizationUserServiceProxy {
  private http: HttpClient;
  private baseUrl: string;
  protected jsonParseReviver: ((key: string, value: any) => any) | undefined =
    undefined;
   ...
   */
  getOrganizationUser(
    body: OrganizationUserGuidGetDto | undefined
  ): Observable<OrganizationUserOutputDto[]> {
    let url_ =
      this.baseUrl +
      '/api/services/sso/read/OrganizationUser/GetOrganizationUser';
    url_ = url_.replace(/[?&]$/, '');
  ...
  protected processGetOrganizationUser(
    response: HttpResponseBase
  ): Observable<OrganizationUserOutputDto[]> {
    const status = response.status;
    const responseBlob =
   ...
   * @return Success
   */
  getClientOrganizationUser(
    body: OrganizationUserGuidGetDto | undefined
  ): Observable<OrganizationUserOutputDto[]> {
    let url_ =
      this.baseUrl +
      '/api/services/sso/read/OrganizationUser/GetClientOrganizationUser';
    url_ = url_.replace(/[?&]$/, '');
  ...
  protected processGetClientOrganizationUser(
    response: HttpResponseBase
  ): Observable<OrganizationUserOutputDto[]> {
    const status = response.status;
    const responseBlob =
   ...
   * @return Success
   */
  getUserNotInOrganization(
    body: OrganizationUserGuidGetDto | undefined
  ): Observable<UserOutputDto[]> {
    let url_ =
      this.baseUrl +
      '/api/services/sso/read/OrganizationUser/GetUserNotInOrganization';
    url_ = url_.replace(/[?&]$/, '');
  ...
  protected processGetUserNotInOrganization(
    response: HttpResponseBase
  ): Observable<UserOutputDto[]> {
    const status = response.status;
    const responseBlob =
   ...
   * @return Success
   */
  getAllTenantOrganizationByUserId(
    body: GetOrganizationUserDto | undefined
  ): Observable<TenantOrganizationDto[]> {
    let url_ =
      this.baseUrl +
      '/api/services/sso/read/OrganizationUser/GetAllTenantOrganizationByUserId';
    url_ = url_.replace(/[?&]$/, '');
    ...
    return this.http
      ...
      .pipe(
        _observableCatch((response_: any) => {
          if (response_ instanceof HttpResponseBase) {
            try {
              return this.processGetAllTenantOrganizationByUserId(
                response_ as any
              );
            } catch (e) {
              return _observableThrow(e) as any as Observable<
  ...
  protected processGetAllTenantOrganizationByUserId(
    response: HttpResponseBase
  ): Observable<TenantOrganizationDto[]> {
    const status = response.status;
    const responseBlob =
  ...
  getByUserId(
    ...
    let url_ =
      this.baseUrl + '/api/services/sso/read/OrganizationUser/GetByUserId';
    url_ = url_.replace(/[?&]$/, '');
        ...
        _observableCatch((response_: any) => {
          if (response_ instanceof HttpResponseBase) {
            try {
              ...
              return _observableThrow(
                e
              ) as any as Observable<OrganizationUserOutputDto>;
            }
          } else
            return _observableThrow(
              response_
        ...
        _observableMergeMap((_responseText: string) => {
          ...
          let resultData200 =
            _responseText === ''
              ? null
              : JSON.parse(_responseText, this.jsonParseReviver);
          result200 = OrganizationUserOutputDto.fromJS(resultData200.result);
          return _observableOf(result200);
        })
      );
    } else if (status !== 200 && status !== 204) {
  ...
  getOrganizationalChart(
    body: OrganizationalChartInputDto | undefined
  ): Observable<OrganizationChartDto> {
    let url_ =
      this.baseUrl +
      '/api/services/sso/read/OrganizationUser/GetOrganizationalChart';
    url_ = url_.replace(/[?&]$/, '');
        ...
        _observableCatch((response_: any) => {
          if (response_ instanceof HttpResponseBase) {
            try {
              ...
              return _observableThrow(
                e
              ) as any as Observable<OrganizationChartDto>;
            }
          } else
            return _observableThrow(
              response_
  ...
  protected processGetOrganizationalChart(
    response: HttpResponseBase
  ): Observable<OrganizationChartDto> {
    const status = response.status;
    const responseBlob =
        ...
        _observableMergeMap((_responseText: string) => {
          ...
          let resultData200 =
            _responseText === ''
              ? null
              : JSON.parse(_responseText, this.jsonParseReviver);
          result200 = OrganizationChartDto.fromJS(resultData200.result);
          return _observableOf(result200);
        })
      );
    } else if (status !== 200 && status !== 204) {
   ...
   */
  inviteUser(
    body: OrganizationUserInputDto | undefined
  ): Observable<OrganizationUserDto> {
    let url_ =
      this.baseUrl + '/api/services/sso/write/OrganizationUser/InviteUser';
    url_ = url_.replace(/[?&]$/, '');
        ...
        _observableCatch((response_: any) => {
          if (response_ instanceof HttpResponseBase) {
            try {
              ...
              return _observableThrow(
                e
              ) as any as Observable<OrganizationUserDto>;
            }
          } else
            return _observableThrow(
              response_
        ...
        _observableMergeMap((_responseText: string) => {
          ...
          let resultData200 =
            _responseText === ''
              ? null
              : JSON.parse(_responseText, this.jsonParseReviver);
          result200 = OrganizationUserDto.fromJS(resultData200.result);
          return _observableOf(result200);
        })
      );
    } else if (status !== 200 && status !== 204) {
   ...
   */
  confirmInviteUser(
    body: ConfirmOrganizationUserDto | undefined
  ): Observable<OrganizationUserDto> {
    let url_ =
      this.baseUrl +
      '/api/services/sso/write/OrganizationUser/ConfirmInviteUser';
    url_ = url_.replace(/[?&]$/, '');
  ...
  protected processConfirmInviteUser(
    response: HttpResponseBase
  ): Observable<OrganizationUserDto> {
    const status = response.status;
    const responseBlob =
  ...
  userJoinOrganization(
    ...
    let url_ =
      this.baseUrl +
      '/api/services/sso/write/OrganizationUser/UserJoinOrganization';
    url_ = url_.replace(/[?&]$/, '');
  ...
  protected processUserJoinOrganization(
    response: HttpResponseBase
  ): Observable<OrganizationUserDto> {
    const status = response.status;
    const responseBlob =
  ...
  confirmUser(
    ...
    let url_ =
      this.baseUrl + '/api/services/sso/write/OrganizationUser/ConfirmUser';
    url_ = url_.replace(/[?&]$/, '');
   ...
   */
  addOrganizationUser(
    body: AddOrganizationUserDto | undefined
  ): Observable<OrganizationUserDto> {
    let url_ =
      this.baseUrl +
      '/api/services/sso/write/OrganizationUser/AddOrganizationUser';
    url_ = url_.replace(/[?&]$/, '');
  ...
  protected processAddOrganizationUser(
    response: HttpResponseBase
  ): Observable<OrganizationUserDto> {
    const status = response.status;
    const responseBlob =
  ...
  setOrganizationUser(
    ...
    let url_ =
      this.baseUrl +
      '/api/services/sso/write/OrganizationUser/SetOrganizationUser';
    url_ = url_.replace(/[?&]$/, '');
  ...
  protected processSetOrganizationUser(
    response: HttpResponseBase
  ): Observable<OrganizationUserDto> {
    const status = response.status;
    const responseBlob =
   ...
   * @return Success
   */
  lockOrganizationUser(
    body: OrganizationUserInputDto | undefined
  ): Observable<OrganizationUserDto> {
    let url_ =
      this.baseUrl +
      '/api/services/sso/write/OrganizationUser/LockOrganizationUser';
    url_ = url_.replace(/[?&]$/, '');
  ...
  protected processLockOrganizationUser(
    response: HttpResponseBase
  ): Observable<OrganizationUserDto> {
    const status = response.status;
    const responseBlob =
   ...
   * @return Success
   */
  unLockOrganizationUser(
    body: OrganizationUserInputDto | undefined
  ): Observable<OrganizationUserDto> {
    let url_ =
      this.baseUrl +
      '/api/services/sso/write/OrganizationUser/UnLockOrganizationUser';
    url_ = url_.replace(/[?&]$/, '');
  ...
  protected processUnLockOrganizationUser(
    response: HttpResponseBase
  ): Observable<OrganizationUserDto> {
    const status = response.status;
    const responseBlob =
  ...
  leaveOrganizationUser(
    ...
    let url_ =
      this.baseUrl +
      '/api/services/sso/write/OrganizationUser/LeaveOrganizationUser';
    url_ = url_.replace(/[?&]$/, '');
  ...
  protected processLeaveOrganizationUser(
    response: HttpResponseBase
  ): Observable<OrganizationUserDto> {
    const status = response.status;
    const responseBlob =
  ...
  removeOrganizationUser(
    ...
    let url_ =
      this.baseUrl +
      '/api/services/sso/write/OrganizationUser/RemoveOrganizationUser';
    url_ = url_.replace(/[?&]$/, '');
  ...
  protected processRemoveOrganizationUser(
    response: HttpResponseBase
  ): Observable<void> {
    const status = response.status;
    const responseBlob =
...
@Injectable()
export class SSO_PermissionServiceProxy {
  private http: HttpClient;
  private baseUrl: string;
  protected jsonParseReviver: ((key: string, value: any) => any) | undefined =
    undefined;
   ...
   */
  getList(
    body: TenantPermissionGuidGetDto | undefined
  ): Observable<PermissionOutputDto[]> {
        ...
        _observableCatch((response_: any) => {
          if (response_ instanceof HttpResponseBase) {
            try {
              ...
              return _observableThrow(
                e
              ) as any as Observable<PermissionOutputDto>;
            }
          } else
            return _observableThrow(
              response_
   ...
   */
  create(
    body: PermissionInputDto | undefined
  ): Observable<PermissionOutputDto> {
   ...
   */
  createOrUpdateList(
    body: PermissionInputDto[] | null | undefined
  ): Observable<PermissionOutputDto[]> {
    let url_ =
      this.baseUrl + '/api/services/sso/write/Permission/CreateOrUpdateList';
    url_ = url_.replace(/[?&]$/, '');
...
@Injectable()
export class SSO_PermissionClientServiceProxy {
  private http: HttpClient;
  private baseUrl: string;
  protected jsonParseReviver: ((key: string, value: any) => any) | undefined =
    undefined;
...
@Injectable()
export class SSO_RegistrationServiceProxy {
  private http: HttpClient;
  private baseUrl: string;
  protected jsonParseReviver: ((key: string, value: any) => any) | undefined =
    undefined;
  ...
  checkValidTenant(body: CheckValidTenantDto | undefined): Observable<boolean> {
    let url_ =
      this.baseUrl + '/api/services/sso/read/Registration/CheckValidTenant';
    url_ = url_.replace(/[?&]$/, '');
  ...
  protected processCheckValidTenant(
    response: HttpResponseBase
  ): Observable<boolean> {
    const status = response.status;
    const responseBlob =
   ...
   */
  registerTenant(
    body: RegisterTenantDto | undefined
  ): Observable<RegisterResultDto> {
    let url_ =
      this.baseUrl + '/api/services/sso/write/Registration/RegisterTenant';
    url_ = url_.replace(/[?&]$/, '');
        ...
        _observableCatch((response_: any) => {
          if (response_ instanceof HttpResponseBase) {
            try {
              ...
              return _observableThrow(
                e
              ) as any as Observable<RegisterResultDto>;
            }
          } else
            return _observableThrow(
              response_
        ...
        _observableMergeMap((_responseText: string) => {
          ...
          let resultData200 =
            _responseText === ''
              ? null
              : JSON.parse(_responseText, this.jsonParseReviver);
          result200 = RegisterResultDto.fromJS(resultData200.result);
          return _observableOf(result200);
        })
      );
    } else if (status !== 200 && status !== 204) {
   ...
   */
  registerUser(
    body: RegisterUserDto | undefined
  ): Observable<RegisterResultDto> {
    let url_ =
      this.baseUrl + '/api/services/sso/write/Registration/RegisterUser';
    url_ = url_.replace(/[?&]$/, '');
   ...
   */
  registerListUser(
    body: RegisterUserDto[] | null | undefined
  ): Observable<RegisterUserDto[]> {
    let url_ =
      this.baseUrl + '/api/services/sso/write/Registration/RegisterListUser';
    url_ = url_.replace(/[?&]$/, '');
  ...
  protected processRegisterListUser(
    response: HttpResponseBase
  ): Observable<RegisterUserDto[]> {
    const status = response.status;
    const responseBlob =
   ...
   * @return Success
   */
  registerOrUpdateListUser(
    body: RegisterUserDto[] | null | undefined
  ): Observable<RegisterUserDto[]> {
    let url_ =
      this.baseUrl +
      '/api/services/sso/write/Registration/RegisterOrUpdateListUser';
    url_ = url_.replace(/[?&]$/, '');
  ...
  protected processRegisterOrUpdateListUser(
    response: HttpResponseBase
  ): Observable<RegisterUserDto[]> {
    const status = response.status;
    const responseBlob =
...
@Injectable()
export class SSO_SendEmailJobServiceProxy {
  private http: HttpClient;
  private baseUrl: string;
  protected jsonParseReviver: ((key: string, value: any) => any) | undefined =
    undefined;
  ...
  sendListMail(body: SendEmailJobArgs[] | null | undefined): Observable<void> {
    let url_ =
      this.baseUrl + '/api/services/sso/write/SendEmailJob/SendListMail';
    url_ = url_.replace(/[?&]$/, '');
...
@Injectable()
export class SSO_SettingServiceProxy {
  private http: HttpClient;
  private baseUrl: string;
  protected jsonParseReviver: ((key: string, value: any) => any) | undefined =
    undefined;
  ...
  protected processCreateByTenant(
    response: HttpResponseBase
  ): Observable<void> {
    const status = response.status;
    const responseBlob =
...
@Injectable()
export class SSO_SSOServiceProxy {
  private http: HttpClient;
  private baseUrl: string;
  protected jsonParseReviver: ((key: string, value: any) => any) | undefined =
    undefined;
   ...
   * @return Success
   */
  getListTenantByApplication(
    body: GuidEntityDto | undefined
  ): Observable<TenantDto[]> {
    let url_ =
      this.baseUrl + '/api/services/sso/read/SSO/GetListTenantByApplication';
    url_ = url_.replace(/[?&]$/, '');
  ...
  protected processGetListTenantByApplication(
    response: HttpResponseBase
  ): Observable<TenantDto[]> {
    const status = response.status;
    const responseBlob =
   ...
   */
  getAllClient(
    body: Int32EntityDto | undefined
  ): Observable<ClientSSOOrganizationUserDto[]> {
  ...
  protected processGetAllInfinity(
    response: HttpResponseBase
  ): Observable<SSOOrganizationDto[]> {
    const status = response.status;
    const responseBlob =
   ...
   */
  getClientOrganizationUser(
    body: ValidationShareKeyDto | undefined
  ): Observable<SSOOrganizationUserDto[]> {
    let url_ =
      this.baseUrl + '/api/services/sso/read/SSO/GetClientOrganizationUser';
    url_ = url_.replace(/[?&]$/, '');
  ...
  protected processCheckShareKey(
    response: HttpResponseBase
  ): Observable<boolean> {
    const status = response.status;
    const responseBlob =
...
@Injectable()
export class SSO_TemplateServiceProxy {
  private http: HttpClient;
  private baseUrl: string;
  protected jsonParseReviver: ((key: string, value: any) => any) | undefined =
    undefined;
      ...
      .pipe(
        _observableCatch((response_: any) => {
          if (response_ instanceof HttpResponseBase) {
            ...
            return _observableThrow(
              response_
            ) as any as Observable<TemplateDto>;
        })
      );
  }
        ...
        _observableMergeMap((_responseText: string) => {
          ...
          let resultData200 =
            _responseText === ''
              ? null
              : JSON.parse(_responseText, this.jsonParseReviver);
          result200 = TemplateDto.fromJS(resultData200.result);
          return _observableOf(result200);
        })
      );
    } else if (status !== 200 && status !== 204) {
   ...
   */
  systemGetList(
    body: TemplateGuidGetDto | undefined
  ): Observable<TemplateDto[]> {
  ...
  protected processSystemGetList(
    response: HttpResponseBase
  ): Observable<TemplateDto[]> {
    const status = response.status;
    const responseBlob =
...
@Injectable()
export class SSO_TenantServiceProxy {
  private http: HttpClient;
  private baseUrl: string;
  protected jsonParseReviver: ((key: string, value: any) => any) | undefined =
    undefined;
  ...
  protected processGetCurrentProfile(
    response: HttpResponseBase
  ): Observable<TenantDto> {
    const status = response.status;
    const responseBlob =
  ...
  protected processGetAllTenants(
    response: HttpResponseBase
  ): Observable<TenantDto[]> {
    const status = response.status;
    const responseBlob =
  ...
  protected processCheckTenancyName(
    response: HttpResponseBase
  ): Observable<boolean> {
    const status = response.status;
    const responseBlob =
  ...
  protected processAddApplication(
    response: HttpResponseBase
  ): Observable<void> {
    const status = response.status;
    const responseBlob =
  ...
  updateApplication(body: ApplicationDto | undefined): Observable<void> {
    let url_ =
      this.baseUrl + '/api/services/sso/write/Tenant/UpdateApplication';
    url_ = url_.replace(/[?&]$/, '');
  ...
  protected processUpdateApplication(
    response: HttpResponseBase
  ): Observable<void> {
    const status = response.status;
    const responseBlob =
  ...
  removeApplication(body: ApplicationDto | undefined): Observable<void> {
    let url_ =
      this.baseUrl + '/api/services/sso/write/Tenant/RemoveApplication';
    url_ = url_.replace(/[?&]$/, '');
  ...
  protected processRemoveApplication(
    response: HttpResponseBase
  ): Observable<void> {
    const status = response.status;
    const responseBlob =
...
@Injectable()
export class SSO_TitleServiceProxy {
  private http: HttpClient;
  private baseUrl: string;
  protected jsonParseReviver: ((key: string, value: any) => any) | undefined =
    undefined;
      ...
      .pipe(
        _observableCatch((response_: any) => {
          if (response_ instanceof HttpResponseBase) {
            ...
            return _observableThrow(
              response_
            ) as any as Observable<TitleOutputDto>;
        })
      );
  }
        ...
        _observableMergeMap((_responseText: string) => {
          ...
          let resultData200 =
            _responseText === ''
              ? null
              : JSON.parse(_responseText, this.jsonParseReviver);
          result200 = TitleOutputDto.fromJS(resultData200.result);
          return _observableOf(result200);
        })
      );
    } else if (status !== 200 && status !== 204) {
   ...
   */
  createOrUpdateList(
    body: TitleInputDto[] | null | undefined
  ): Observable<void> {
    let url_ =
      this.baseUrl + '/api/services/sso/write/Title/CreateOrUpdateList';
    url_ = url_.replace(/[?&]$/, '');
...
@Injectable()
export class SSO_TitleClientServiceProxy {
  private http: HttpClient;
  private baseUrl: string;
  protected jsonParseReviver: ((key: string, value: any) => any) | undefined =
    undefined;
...
@Injectable()
export class SSO_TokenAuthServiceProxy {
  private http: HttpClient;
  private baseUrl: string;
  protected jsonParseReviver: ((key: string, value: any) => any) | undefined =
    undefined;
   ...
   */
  changeToken(
    body: UserTenantModel | undefined
  ): Observable<AuthenticateResultModel[]> {
...
@Injectable()
export class SSO_UserServiceProxy {
  private http: HttpClient;
  private baseUrl: string;
  protected jsonParseReviver: ((key: string, value: any) => any) | undefined =
    undefined;
  ...
  protected processGetListOwner(
    response: HttpResponseBase
  ): Observable<UserOwnerDto[]> {
    const status = response.status;
    const responseBlob =
      response instanceof HttpResponse
        ? response.body
      ...
      .pipe(
        _observableCatch((response_: any) => {
          if (response_ instanceof HttpResponseBase) {
            ...
            return _observableThrow(
              response_
            ) as any as Observable<UserOutputDto>;
        })
      );
  }

  protected processGetAdmin(
    response: HttpResponseBase
  ): Observable<UserOutputDto> {
    const status = response.status;
    const responseBlob =
   ...
   */
  getUserByTime(
    body: GetUserByTimeDto | undefined
  ): Observable<UserOutputDto[]> {
  ...
  protected processGetUserByTime(
    response: HttpResponseBase
  ): Observable<UserOutputDto[]> {
    const status = response.status;
    const responseBlob =
   ...
   * @return Success
   */
  getListUserTenantByApplication(
    body: GuidEntityDto | undefined
  ): Observable<UserInfoTenantDto[]> {
    let url_ =
      this.baseUrl +
      '/api/services/sso/read/User/GetListUserTenantByApplication';
    url_ = url_.replace(/[?&]$/, '');
    ...
    return this.http
      ...
      .pipe(
        _observableCatch((response_: any) => {
          if (response_ instanceof HttpResponseBase) {
            try {
              return this.processGetListUserTenantByApplication(
                response_ as any
              );
            } catch (e) {
              return _observableThrow(e) as any as Observable<
  ...
  protected processGetListUserTenantByApplication(
    response: HttpResponseBase
  ): Observable<UserInfoTenantDto[]> {
    const status = response.status;
    const responseBlob =
   ...
   */
  getListUserTenant(
    body: GetUserTenantDto | undefined
  ): Observable<UserInfoTenantDto[]> {
  ...
  protected processGetListUserTenant(
    response: HttpResponseBase
  ): Observable<UserInfoTenantDto[]> {
    const status = response.status;
    const responseBlob =
   ...
   */
  getPageUsers(
    body: UserInt64GetDto | undefined
  ): Observable<UserOutputDtoPagedResultDto> {
        ...
        _observableCatch((response_: any) => {
          if (response_ instanceof HttpResponseBase) {
            try {
              ...
              return _observableThrow(
                e
              ) as any as Observable<UserOutputDtoPagedResultDto>;
            }
          } else
            return _observableThrow(
              response_
      ...
      .pipe(
        _observableCatch((response_: any) => {
          if (response_ instanceof HttpResponseBase) {
            ...
            return _observableThrow(
              response_
            ) as any as Observable<UserInfoDto>;
        })
      );
  }
        ...
        _observableMergeMap((_responseText: string) => {
          ...
          let resultData200 =
            _responseText === ''
              ? null
              : JSON.parse(_responseText, this.jsonParseReviver);
          result200 = UserInfoDto.fromJS(resultData200.result);
          return _observableOf(result200);
        })
      );
    } else if (status !== 200 && status !== 204) {
  ...
  getCurrentUserPermission(): Observable<UserPermissionDto> {
    let url_ =
      this.baseUrl + '/api/services/sso/read/User/GetCurrentUserPermission';
    url_ = url_.replace(/[?&]$/, '');
        ...
        _observableCatch((response_: any) => {
          if (response_ instanceof HttpResponseBase) {
            try {
              ...
              return _observableThrow(
                e
              ) as any as Observable<UserPermissionDto>;
            }
          } else
            return _observableThrow(
              response_
  ...
  protected processGetCurrentUserPermission(
    response: HttpResponseBase
        ...
        _observableMergeMap((_responseText: string) => {
          ...
          let resultData200 =
            _responseText === ''
              ? null
              : JSON.parse(_responseText, this.jsonParseReviver);
          result200 = UserPermissionDto.fromJS(resultData200.result);
          return _observableOf(result200);
        })
      );
    } else if (status !== 200 && status !== 204) {
  ...
  protected processGetSearchUsers(
    response: HttpResponseBase
  ): Observable<UserOutputDto[]> {
    const status = response.status;
    const responseBlob =
  ...
  checkEmailAddressOrUserName(body: UserDto | undefined): Observable<boolean> {
    let url_ =
      this.baseUrl + '/api/services/sso/read/User/CheckEmailAddressOrUserName';
    url_ = url_.replace(/[?&]$/, '');
  ...
  protected processCheckEmailAddressOrUserName(
    response: HttpResponseBase
  ): Observable<boolean> {
    const status = response.status;
    const responseBlob =
   ...
   * @return Success
   */
  changePasswordUserInFamily(
    body: ChangePasswordInFamilyDto | undefined
  ): Observable<void> {
    let url_ =
      this.baseUrl + '/api/services/sso/write/User/ChangePasswordUserInFamily';
    url_ = url_.replace(/[?&]$/, '');
  ...
  protected processChangePasswordUserInFamily(
    response: HttpResponseBase
  ): Observable<void> {
    const status = response.status;
    const responseBlob =
   ...
   * @return Success
   */
  changeAccountUserInFamily(
    body: ChangeUserPasswordInFamilyDto | undefined
  ): Observable<void> {
    let url_ =
      this.baseUrl + '/api/services/sso/write/User/ChangeAccountUserInFamily';
    url_ = url_.replace(/[?&]$/, '');
  ...
  protected processChangeAccountUserInFamily(
    response: HttpResponseBase
  ): Observable<void> {
    const status = response.status;
    const responseBlob =
  ...
  protected processUpdateShareKey(
    response: HttpResponseBase
  ): Observable<void> {
    const status = response.status;
    const responseBlob =
  ...
  protected processJoinApplication(
    response: HttpResponseBase
  ): Observable<void> {
    const status = response.status;
    const responseBlob =
  ...
  changeDefaultTenant(body: TenantUserDto | undefined): Observable<void> {
    let url_ =
      this.baseUrl + '/api/services/sso/write/User/ChangeDefaultTenant';
    url_ = url_.replace(/[?&]$/, '');
  ...
  protected processChangeDefaultTenant(
    response: HttpResponseBase
  ): Observable<void> {
    const status = response.status;
    const responseBlob =
...
export class SSOCategoryGuidGetDto implements ISSOCategoryGuidGetDto {
  ...
  init(_data?: any) {
    if (_data) {
      ...
      if (Array.isArray(_data['sValue'])) {
        this.sValue = [] as any;
        for (let item of _data['sValue']) this.sValue!.push(item);
      }
      if (Array.isArray(_data['lValue'])) {
        this.lValue = [] as any;
        for (let item of _data['lValue']) this.lValue!.push(item);
      }
      if (Array.isArray(_data['gValue'])) {
        this.gValue = [] as any;
        for (let item of _data['gValue']) this.gValue!.push(item);
      }
      if (Array.isArray(_data['dValue'])) {
        this.dValue = [] as any;
        for (let item of _data['dValue']) this.dValue!.push(item);
      }
      if (Array.isArray(_data['tValue'])) {
        this.tValue = [] as any;
        for (let item of _data['tValue']) this.tValue!.push(new Date(item));
      }
  ...
  toJSON(data?: any) {
    ...
    if (Array.isArray(this.sValue)) {
      data['sValue'] = [];
      for (let item of this.sValue) data['sValue'].push(item);
    }
    if (Array.isArray(this.lValue)) {
      data['lValue'] = [];
      for (let item of this.lValue) data['lValue'].push(item);
    }
    if (Array.isArray(this.gValue)) {
      data['gValue'] = [];
      for (let item of this.gValue) data['gValue'].push(item);
    }
    if (Array.isArray(this.dValue)) {
      data['dValue'] = [];
      for (let item of this.dValue) data['dValue'].push(item);
    }
    if (Array.isArray(this.tValue)) {
      data['tValue'] = [];
      for (let item of this.tValue) data['tValue'].push(item.toISOString());
    }
...
export class SSOCategoryOutputDto implements ISSOCategoryOutputDto {
  ...
  init(_data?: any) {
    if (_data) {
      ...
      this.valuePermissions = _data['valuePermissions']
        ? ValueCategoryPermissionDto.fromJS(_data['valuePermissions'])
        : <any>undefined;
      this.tenantId = _data['tenantId'];
  ...
  toJSON(data?: any) {
    ...
    data['valuePermissions'] = this.valuePermissions
      ? this.valuePermissions.toJSON()
      : <any>undefined;
    data['tenantId'] = this.tenantId;
  ...
  init(_data?: any) {
    if (_data) {
      ...
      this.user = _data['user']
        ? UserInputDto.fromJS(_data['user'])
        : <any>undefined;
      this.familyKeys = _data['familyKeys'];
...
export class GetByListUserDto implements IGetByListUserDto {
  ...
  init(_data?: any) {
    if (_data) {
      if (Array.isArray(_data['listUserId'])) {
        ...
        for (let item of _data['listUserId']) this.listUserId!.push(item);
      }
    }
  }
  ...
  toJSON(data?: any) {
    ...
    if (Array.isArray(this.listUserId)) {
      data['listUserId'] = [];
      for (let item of this.listUserId) data['listUserId'].push(item);
    }
    return data;
  }
}
  ...
  init(_data?: any) {
    if (_data) {
      ...
      this.expiredTime = _data['expiredTime']
        ? new Date(_data['expiredTime'].toString())
        : <any>undefined;
    }
  }
...
export class OrganizationOutputDto implements IOrganizationOutputDto {
  ...
  init(_data?: any) {
    if (_data) {
      ...
      this.parentName = _data['parentName'];
      this.securityCode = _data['securityCode'];
      this.activeCode = _data['activeCode']
        ? OrganizationActiveCodeDto.fromJS(_data['activeCode'])
        : <any>undefined;
  ...
  toJSON(data?: any) {
    ...
    data['activeCode'] = this.activeCode
      ? this.activeCode.toJSON()
      : <any>undefined;
    if (Array.isArray(this.listTitle)) {
      data['listTitle'] = [];
      for (let item of this.listTitle) data['listTitle'].push(item.toJSON());
    }
...
export class OrganizationUserOutputDto implements IOrganizationUserOutputDto {
  ...
  init(_data?: any) {
    if (_data) {
      this.user = _data['user']
        ? UserOutputDto.fromJS(_data['user'])
        : <any>undefined;
    ...
    if (_data) {
      ...
      if (Array.isArray(_data['listOrganizationUser'])) {
        ...
        for (let item of _data['listOrganizationUser'])
          this.listOrganizationUser!.push(
            OrganizationUserOutputDto.fromJS(item)
          );
      }
      this.parentId = _data['parentId'];
      this.index = _data['index'];
...
export class TenantOrganizationDto implements ITenantOrganizationDto {
  ...
  init(_data?: any) {
    if (_data) {
      ...
      this.fileLogoCompany = _data['fileLogoCompany']
        ? FileDto.fromJS(_data['fileLogoCompany'])
        : <any>undefined;
      this.tenancyName = _data['tenancyName'];
      this.name = _data['name'];
      this.status = _data['status'];
  ...
  toJSON(data?: any) {
    ...
    data['fileLogoCompany'] = this.fileLogoCompany
      ? this.fileLogoCompany.toJSON()
      : <any>undefined;
    data['tenancyName'] = this.tenancyName;
    data['name'] = this.name;
    data['status'] = this.status;
...
export class OrganizationalChartInputDto
  implements IOrganizationalChartInputDto
{
  ...
  init(_data?: any) {
    if (_data) {
      ...
      if (Array.isArray(_data['listStatus'])) {
        ...
        for (let item of _data['listStatus']) this.listStatus!.push(item);
      }
      ...
      if (Array.isArray(_data['listTitleId'])) {
        ...
        for (let item of _data['listTitleId']) this.listTitleId!.push(item);
      }
  ...
  toJSON(data?: any) {
    ...
    if (Array.isArray(this.listCategoryId)) {
      data['listCategoryId'] = [];
      for (let item of this.listCategoryId) data['listCategoryId'].push(item);
    }
    if (Array.isArray(this.listStatus)) {
      data['listStatus'] = [];
      for (let item of this.listStatus) data['listStatus'].push(item);
    }
    ...
    if (Array.isArray(this.listTitleId)) {
      data['listTitleId'] = [];
      for (let item of this.listTitleId) data['listTitleId'].push(item);
    }
...
export class UserDto implements IUserDto {
  ...
  init(_data?: any) {
    if (_data) {
      ...
      this.contacts = _data['contacts'];
      this.phoneNumber = _data['phoneNumber'];
      this.dataIds = _data['dataIds']
        ? DataIdDto.fromJS(_data['dataIds'])
        : <any>undefined;
      this.tenant = _data['tenant']
        ? ValueTenantDto.fromJS(_data['tenant'])
        : <any>undefined;
  ...
  toJSON(data?: any) {
    ...
    if (Array.isArray(this.listTenant)) {
      data['listTenant'] = [];
      for (let item of this.listTenant) data['listTenant'].push(item.toJSON());
    }
...
export class OrganizationChartDto implements IOrganizationChartDto {
  ...
  toJSON(data?: any) {
    ...
    if (Array.isArray(this.listUser)) {
      data['listUser'] = [];
      for (let item of this.listUser) data['listUser'].push(item.toJSON());
    }
    if (Array.isArray(this.listOrganization)) {
      data['listOrganization'] = [];
      for (let item of this.listOrganization)
...
export class AddOrganizationUserDto implements IAddOrganizationUserDto {
  ...
  init(_data?: any) {
    if (_data) {
      this.organizationUser = _data['organizationUser']
        ? OrganizationUserInputDto.fromJS(_data['organizationUser'])
        : <any>undefined;
      this.user = _data['user']
        ? RegisterUserDto.fromJS(_data['user'])
        : <any>undefined;
    }
  }
  ...
  toJSON(data?: any) {
    data = typeof data === 'object' ? data : {};
    data['organizationUser'] = this.organizationUser
      ? this.organizationUser.toJSON()
      : <any>undefined;
    data['user'] = this.user ? this.user.toJSON() : <any>undefined;
    return data;
  }
...
export class RegisterTenantDto implements IRegisterTenantDto {
  ...
  init(_data?: any) {
    if (_data) {
      ...
      this.password = _data['password'];
      this.logoCompany = _data['logoCompany']
        ? FileDto.fromJS(_data['logoCompany'])
        : <any>undefined;
...
export class ClientSSOOrganizationUserDto
  implements IClientSSOOrganizationUserDto
{
  userId?: number;
  ...
  init(_data?: any) {
    if (_data) {
      this.timeStart = _data['timeStart']
        ? new Date(_data['timeStart'].toString())
        : <any>undefined;
      this.timeEnd = _data['timeEnd']
        ? new Date(_data['timeEnd'].toString())
        : <any>undefined;
...
export class UserOutputDtoPagedResultDto
  implements IUserOutputDtoPagedResultDto
{
  totalCount?: number;
...
export class OrganizationUserPermissionDto
  implements IOrganizationUserPermissionDto
{
  organizationId?: string;
  listTitle?: ValueTitleDto[] | undefined;
    ...
    if (_data) {
      ...
      if (Array.isArray(_data['organizationListPermission'])) {
        ...
        for (let item of _data['organizationListPermission'])
          this.organizationListPermission!.push(
            OrganizationUserPermissionDto.fromJS(item)
          );
      }
    }
  }
...
export class ChangeUserPasswordInFamilyDto
  implements IChangeUserPasswordInFamilyDto
{
  userName?: string | undefined;
  userId?: number | undefined;
  oldPass?: string | undefined;
